...
|---|---|---|
| 身份与会话 | 登录页为唯一入口；BFF 的账号/无账号患者 HttpOnly cookie、短期 JWT、scope、tenant/actor 所有权、限流；患者可按资源向指定医生授予可撤回的限时读取权 | 患者、医生、管理员账号、基础 RBAC、健康画像/CGA 摘要/处方草案授权及授权患者目录已存在；医生资质和完整跨患者临床工作台仍未实现 |
