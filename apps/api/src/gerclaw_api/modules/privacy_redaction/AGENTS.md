...
identifiers can leave GerClaw. Its first production consumer is external web
search. It returns a safe text projection and bounded category counts, never
...
- Test Chinese/English names, phone numbers, IDs, email, credentials, control
  characters, empty/oversized inputs and absence of source values in findings.
