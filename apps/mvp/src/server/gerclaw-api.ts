...
const proxyRules: Array<{ pattern: RegExp; methods: ReadonlySet<string> }> = [
  ...
  { pattern: /^sessions$/, methods: new Set(["GET", "POST"]) },
  {
  ...
  {
    pattern: /^access-grants\/patients\/usr_account_[a-f0-9]{32}\/prescription-drafts$/,
    methods: new Set(["GET"]),
  },
  {
    pattern: /^access-grants\/patients\/usr_account_[a-f0-9]{32}\/medication-review-drafts$/,
    methods: new Set(["GET"]),
  },
  {
    pattern: new RegExp(
      `^access-grants/patients/usr_account_[a-f0-9]{32}/medication-review-drafts/${uuidPattern}/reviews$`,
      "i"
    ),
    methods: new Set(["POST"]),
  },
  {
    pattern: /^access-grants\/patients\/usr_account_[a-f0-9]{32}\/risk-alerts$/,
    methods: new Set(["GET"]),
  },
  {
    pattern: /^access-grants\/patients\/usr_account_[a-f0-9]{32}\/cga-reports$/,
    methods: new Set(["GET"]),
  },
  {
    pattern: /^access-grants\/patients\/usr_account_[a-f0-9]{32}\/health-profile$/,
    methods: new Set(["GET"]),
  },
  {
    pattern: new RegExp(
      `^access-grants/patients/usr_account_[a-f0-9]{32}/prescription-drafts/${uuidPattern}/reviews$`,
      "i"
    ),
    methods: new Set(["POST"]),
  },
  ...
  {
    pattern: new RegExp(`^clinical-intakes/${uuidPattern}/medication-review-draft$`, "i"),
    methods: new Set(["POST"]),
  },
  {
  ...
  {
    pattern: new RegExp(
      `^clinical-intakes/${uuidPattern}/prescription-draft/trace_[A-Za-z0-9][A-Za-z0-9_.:-]{7,57}/cancel$`,
      "i"
    ),
    methods: new Set(["POST"]),
  },
