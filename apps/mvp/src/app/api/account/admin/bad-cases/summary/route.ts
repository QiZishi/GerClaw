...
/** Proxy the aggregate-only operational view; snapshots remain API-internal. */
export async function GET(request: NextRequest): Promise<Response> {
  ...
  const upstream = await fetch(`${getGerclawApiBaseUrl()}/api/v1/auth/admin/bad-cases/summary`, {
