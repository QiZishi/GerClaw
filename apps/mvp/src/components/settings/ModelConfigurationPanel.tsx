...
type VoiceDraft = { api_key: string; asr_url: string; asr_model: string; tts_url: string; tts_model: string };
...
function emptyVoice(): VoiceDraft { return { api_key: "", asr_url: "", asr_model: "", tts_url: "", tts_model: "" }; }
...
export function ModelConfigurationPanel({ senior }: { senior: boolean }) {
  ...
  useEffect(() => {
    ...
    void getModelConfiguration().then((configuration) => {
      ...
      setVoice(services.voice ? { api_key: "", asr_url: services.voice.asr_url, asr_model: services.voice.asr_model, tts_url: services.voice.tts_url, tts_model: services.voice.tts_model } : emptyVoice());
  ...
  const save = async () => {
    ...
    try {
      ...
      setVoice(saved.services.voice ? { api_key: "", asr_url: saved.services.voice.asr_url, asr_model: saved.services.voice.asr_model, tts_url: saved.services.voice.tts_url, tts_model: saved.services.voice.tts_model } : emptyVoice());
