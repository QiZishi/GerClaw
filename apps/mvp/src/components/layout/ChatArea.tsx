...
export function ChatArea() {
  ...
  }, [chatAction, currentSessionId, role, createSession, setCurrentSession, addMessage, setGenerating, setPanelContent, updateMessage, appendMessageText, initMessageThinking, startMessageThinkingBlock, appendMessageThinking, finalizeMessageThinking]);
