...
- CGA 的 Mini-Cog/MMSE 动作、书写、阅读和时钟绘制仍仅记录本人作答，不能冒充专业人员观察；患者可向指定医生授权查看已完成 CGA 摘要，医生端不会读取原始答案或活动评估
...
- 医生资质与完整跨患者工作台；医生目前只能从有效授权患者目录进入，再按资源范围读取已确认健康画像、完成 CGA 摘要或复核处方草案；仍缺账号找回、MFA 和临床执业授权
