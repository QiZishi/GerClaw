...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  gerclawAccountStore: 'private GerClaw account storage service — packages/gerclaw/auth-storage/README.md',
  gerclawApp: 'private GerClaw product service — packages/gerclaw/profile-bundle/README.md',
  gerclawArtifacts: 'private GerClaw artifact service — packages/gerclaw/artifact/README.md',
  gerclawAuth: 'private GerClaw authentication service — packages/gerclaw/auth/README.md',
  gerclawCga: 'private GerClaw medical service — packages/gerclaw/profile-bundle/README.md',
  gerclawChronicCare: 'private GerClaw medical service — packages/gerclaw/profile-bundle/README.md',
  gerclawCompanion: 'private GerClaw medical service — packages/gerclaw/profile-bundle/README.md',
  gerclawDocumentParser: 'private GerClaw document parser service — packages/gerclaw/document-parser/README.md',
  gerclawHealthProfile: 'private GerClaw medical service — packages/gerclaw/profile-bundle/README.md',
  healthRepository: 'private GerClaw health repository service — packages/gerclaw/health-repository/README.md',
  gerclawLibrary: 'private GerClaw account library service — packages/gerclaw/library/README.md',
  gerclawLibraryRuntime: 'private GerClaw retrieval runtime service — packages/gerclaw/library-dsh-runtime/README.md',
  gerclawMedicalEvidence: 'private GerClaw medical service — packages/gerclaw/profile-bundle/README.md',
  gerclawMedicationReview: 'private GerClaw medical service — packages/gerclaw/profile-bundle/README.md',
  gerclawPrescription: 'private GerClaw medical service — packages/gerclaw/profile-bundle/README.md',
  gerclawRag: 'private GerClaw medical service — packages/gerclaw/profile-bundle/README.md',
  gerclawRiskAlert: 'private GerClaw medical service — packages/gerclaw/profile-bundle/README.md',
  gerclawSharedKnowledge: 'private GerClaw shared knowledge service — packages/gerclaw/local-rag/README.md',
  gerclawTasks: 'private GerClaw task service — packages/gerclaw/task-runtime/README.md',
  gerclawTenantHost: 'private GerClaw tenancy service — packages/gerclaw/tenant-host/README.md',
  gerclawTenantHostInstance: 'private GerClaw local tenancy service — packages/gerclaw/tenant-host-local/README.md',
  gerclawVoiceFiles: 'client-side GerClaw voice file service — packages/gerclaw/voice/README.md',
  speech: 'private GerClaw speech protocol service — packages/gerclaw/speech/README.md',
...
export const EVENT_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  'gerclaw/artifacts-created': 'client-face artifact refresh signal — packages/gerclaw/client-ui/README.md owns the API',
